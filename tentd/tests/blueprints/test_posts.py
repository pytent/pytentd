...
@mark.usefixtures('post')
class TestPostBlueprint(object):
    ...
    def test_get_posts(self, entity):
    ...
    def test_create_post(self, entity):
        data = {
